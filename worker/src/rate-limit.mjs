...
// T-PROOFCLIP-V067-005). This is an abuse guard, not an accounting
// mechanism: it lives in one isolate and Cloudflare may run several, so it
// bounds single-isolate burst traffic only. Responses built from it never
// include request content or keys.
