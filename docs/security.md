...
Before public release, verify the repository with `pwsh -NoProfile -File scripts/verify-public-source.ps1 -IncludeUntracked`. This is a local source gate, not a substitute for a fresh deployment rehearsal or independent security review.
