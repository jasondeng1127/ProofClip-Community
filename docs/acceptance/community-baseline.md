...
- Created an independent Community Git repository; it does not share the
  private workspace Git directory or history.
...
- 2026: maintainer approved the swap; `extension/` and `worker/` now hold the
  0.8 tree. The historical 0.7 backup remains outside the authoritative
  source tree. Repo-mode commercial-boundary scan CLEAN.
