...
This repository is a self-hosted Community project. Contributions must preserve that boundary: no central hosted dependency, no private account identifiers, no tokens or keys, and no capture telemetry.
