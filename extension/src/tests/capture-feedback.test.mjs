...
test('successful truncated capture discloses the fixed local text limit', () => {
  assert.match(captureFeedback({ ok: true, locallySaved: true, record: { truncated: true } }).text, /Text truncated at 200,000 characters/);
});
